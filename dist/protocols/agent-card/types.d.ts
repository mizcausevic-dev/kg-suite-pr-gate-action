...
export type ChangeReason = "card-version-changed" | "agent-version-changed" | "agent-name-changed" | "agent-provider-changed" | "agent-description-changed" | "primary-purpose-changed" | "max-context-tokens-decreased" | "max-context-tokens-increased" | "memory-persistence-escalated" | "memory-persistence-relaxed" | "autonomy-escalated" | "autonomy-relaxed" | "model-added" | "model-removed" | "tool-added" | "tool-removed" | "refusal-category-added" | "refusal-category-removed" | "evaluation-added" | "evaluation-removed" | "deployment-changed" | "incident-response-uri-removed" | "incident-response-uri-added";
/**
